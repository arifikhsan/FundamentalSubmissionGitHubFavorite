...
import com.arifikhsan.githubfavorite.config.Constant.USER_ATTRIBUTES.FOLLOWER
        ...
        usersCursor?.apply {
            while (moveToNext()) {
                val user = User(
                    ...
                    follower = getInt(getColumnIndexOrThrow(FOLLOWER)),
    ...
    fun mapContentValuesToObject(contentValues: ContentValues?): User {
        ...
        contentValues?.apply {
            user = User(
                ...
                follower = getAsInteger(FOLLOWER),
